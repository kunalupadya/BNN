...
from models.alexnet_binary import AlexNetOWT_BN_all
...
model = AlexNetOWT_BN_all().to(device)
model.load_state_dict(torch.load('alexnet_binary.pt', map_location=torch.device('cpu')))
...
if __name__ == "__main__":
    ...
    for epoch in range(EPOCHS):
        ...
        if val_losses.avg < best_loss:
            torch.save(model.state_dict(), "alexnetall.pt")
