...
from models.alexnet_binary import AlexNetBNQA
...
if __name__ == "__main__":
    ...
    for epoch in range(EPOCHS):
        ...
        if val_losses.avg < best_loss:
            torch.save(model.state_dict(), "alexnet_binary_qa.pt")
